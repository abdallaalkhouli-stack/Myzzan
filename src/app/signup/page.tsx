  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', background: '#f4f4f4' }}>
      <div style={{ width: '100%', maxWidth: '400px', background: '#ffffff', border: '0.5px solid #e8e8e8', borderRadius: '14px', padding: '40px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: '28px', color: '#1a1a2e', margin: '0 0 4px 0' }}>Get your API Key</h1>
        <p style={{ fontFamily: 'var(--font-body)', fontWeight: 300, fontSize: '13px', color: '#5a7a5a', margin: '0 0 24px 0' }}>Sign up to access Myzzan intelligence.</p>
        ...
        <div style={{ marginTop: '24px', textAlign: 'center' }}>
          <Link href="/login" style={{ fontFamily: 'var(--font-body)', fontSize: '12px', color: '#2a7a4a', textDecoration: 'none' }}>Already have an account? Log in</Link>
        </div>
      </div>
    </div>
  );
